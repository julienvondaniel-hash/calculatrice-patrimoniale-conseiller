...
const SIM_INTROS = {
  ...
  i_foncier: "Impose vos revenus fonciers au régime réel (TMI + prélèvements sociaux) et gère l'imputation du déficit foncier sur le revenu global (≤ 10 700 €), les déficits antérieurs et leur report.",
  i_demembrement: "Calcule la valeur fiscale de l'usufruit et de la nue-propriété selon l'article 669 du CGI : usufruit viager (barème selon l'âge de l'usufruitier) ou usufruit temporaire (23 % par période de 10 ans).",
  sim_immo: "Calcule le TRI d'un investissement locatif financé à crédit, selon 10 régimes fiscaux (revenus fonciers, déficit foncier, Jeanbrun, Denormandie, Loc'Avantages, LMNP, LMP, SCI à l'IS, Malraux, Monument historique), revente comprise.",
